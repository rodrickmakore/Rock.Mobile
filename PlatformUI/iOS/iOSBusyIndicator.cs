...
namespace Rock.Mobile
{
    namespace PlatformUI
    {
        ...
        public class iOSBusyIndicator : PlatformBusyIndicator
        {
            ...
            {
                BusyIndicator.Layer.BackgroundColor = Rock.Mobile.PlatformUI.Util.GetUIColor( backgroundColor ).CGColor;
            }

            protected override uint getBackgroundColor( )
            {
                return Rock.Mobile.PlatformUI.Util.UIColorToInt( BusyIndicator.Layer.BackgroundColor );
            }
            ...
            {
                BusyIndicator.Color = Rock.Mobile.PlatformUI.Util.GetUIColor( value );
            }
