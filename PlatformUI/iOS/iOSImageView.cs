...
namespace Rock.Mobile
{
    namespace PlatformUI
    {
        ...
        public class iOSImageView : PlatformImageView
        {
            ...
            {
                ImageView.Layer.BackgroundColor = Rock.Mobile.PlatformUI.Util.GetUIColor( backgroundColor ).CGColor;
            }

            protected override uint getBackgroundColor( )
            {
                return Rock.Mobile.PlatformUI.Util.UIColorToInt( ImageView.Layer.BackgroundColor );
            }
